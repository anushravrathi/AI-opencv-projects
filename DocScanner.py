...
def getWarp(img,biggest):
    ...
    pts2 = np.float32([[0, 0], [widhtImg, 0], [heightImg, 0], [widhtImg, heightImg]])
    matrix = cv2.getPerspectiveTransform(pts1, pts2)
    imgOutput = cv2.warpPerspective(img, matrix, (widhtImg, heightImg))

    imgCropped = imgOutput[20:imgOutput.shape[0]-20,20:imgOutput.shape[1]-20]
    imgCropped = cv2.resize(imgCropped,(widhtImg,heightImg))
